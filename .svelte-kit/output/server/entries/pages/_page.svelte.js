import { d as unsubscribe_stores, f as html, g as escape_html, h as attr, i as attr_style, l as store_get, o as ensure_array_like, r as attr_class, u as stringify } from "../../chunks/index-server.js";
import "../../chunks/index-server2.js";
import { t as lenisStore } from "../../chunks/stores.js";
import "three";
//#region src/lib/BeamFollower.svelte
function BeamFollower($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		function tick() {
			beamX = lerp(beamX, targetX, .08);
			beamY = lerp(beamY, targetY, .08);
			requestAnimationFrame(tick);
		}
		$$renderer.push(`<div class="beam-area svelte-ri46uu" aria-hidden="true"><div${attr_class("beam-follower svelte-ri46uu", void 0, { "beam-active": active })}${attr_style(`left:${stringify(beamX)}px; top:${stringify(beamY)}px;`)}></div></div>`);
	});
}
//#endregion
...
function Navbar($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$: if (typeof document !== "undefined") {
			...
			store_get($$store_subs ??= {}, "$lenisStore", lenisStore)?.start();
		}
		$$renderer.push(`<header${attr_class("svelte-11lpkcp", void 0, {
			"scrolled": scrolled,
			"menu-open": menuOpen
		...
		$$renderer.push(`<!--]--></button> <button${attr_class("hamburger svelte-11lpkcp", void 0, { "open": menuOpen })}${attr("aria-label", "Open menu")}${attr("aria-expanded", menuOpen)}><span class="hamburger-bar svelte-11lpkcp"></span> <span class="hamburger-bar svelte-11lpkcp"></span></button></div></div></header> <div class="scroll-progress svelte-11lpkcp" aria-hidden="true"><div class="scroll-progress-bar svelte-11lpkcp"${attr_style(`width: ${stringify(scrollProgress * 100)}%`)}></div></div> <div${attr_class("nav-overlay svelte-11lpkcp", void 0, { "open": menuOpen })}${attr("aria-hidden", true)}>`);
		BeamFollower($$renderer, {});
		$$renderer.push(`<!----> <nav class="nav-links svelte-11lpkcp"><a class="nav-item svelte-11lpkcp" style="--i:0" href="#services">Services</a> <a class="nav-item svelte-11lpkcp" style="--i:1" href="#why-us">Why Us</a> <a class="nav-item nav-cta svelte-11lpkcp" style="--i:2" href="#quote">Get a Quote <svg class="icon svelte-11lpkcp" width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 8h10M9 4l4 4-4 4"></path></svg></a></nav></div>`);
...
function Services($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<section id="services" class="section-wrap services svelte-6t9lhf"><svg class="section-bg svelte-6t9lhf" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="svc-dots" width="36" height="36" patternUnits="userSpaceOnUse"><circle cx="1" cy="1" r="0.9" fill="var(--accent)" opacity="0.12"></circle></pattern></defs><rect width="100%" height="100%" fill="url(#svc-dots)"></rect></svg> <div class="inner svelte-6t9lhf"><div class="heading-row svelte-6t9lhf"><div class="section-label">What We Build</div> <h2 class="section-h2 svelte-6t9lhf">Six ways we<br/>move the needle.</h2></div> <div class="svc-grid svelte-6t9lhf"><svg class="pipe-bg svelte-6t9lhf"${attr("viewBox", vb)} preserveAspectRatio="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="var(--accent)" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" opacity="0.25"><path d="M293,-60 L293,185 A40,40,0,0,0,333,225 L867,225 A40,40,0,0,1,907,265 L907,410 A40,40,0,0,1,867,450 L333,450 A40,40,0,0,0,293,490 L293,720"></path><path d="M907,-60 L907,265"></path><path d="M-60,450 L600,450"></path><path d="M600,450 L600,720"></path><path${attr("d", `M${stringify(bW - 30)},-60 L${stringify(bW - 30)},${stringify(bH + 60)}`)}></path><path${attr("d", `M${stringify(bW * .7)},-60 L${stringify(bW * .7)},${stringify(bH + 60)}`)}></path></g><g fill="none" stroke="var(--accent)" stroke-linecap="round" stroke-width="1" opacity="0.8"><path d="M293,-60 L293,185 A40,40,0,0,0,333,225 L867,225 A40,40,0,0,1,907,265 L907,410 A40,40,0,0,1,867,450 L333,450 A40,40,0,0,0,293,490 L293,720" stroke-dasharray="2 28" pathLength="1000"><animate attributeName="stroke-dashoffset" from="0" to="-30" dur="2.8s" repeatCount="indefinite"></animate></path><path d="M907,-60 L907,265" stroke-dasharray="2 28" pathLength="300"><animate attributeName="stroke-dashoffset" from="0" to="-30" dur="2.8s" repeatCount="indefinite"></animate></path><path d="M-60,450 L600,450" stroke-dasharray="2 28" pathLength="300"><animate attributeName="stroke-dashoffset" from="0" to="-30" dur="2.8s" repeatCount="indefinite"></animate></path><path d="M600,450 L600,720" stroke-dasharray="2 28" pathLength="300"><animate attributeName="stroke-dashoffset" from="0" to="-30" dur="2.8s" repeatCount="indefinite"></animate></path><path${attr("d", `M${stringify(bW - 30)},-60 L${stringify(bW - 30)},${stringify(bH + 60)}`)} stroke-dasharray="2 28" pathLength="500"><animate attributeName="stroke-dashoffset" from="0" to="-30" dur="2.8s" repeatCount="indefinite"></animate></path><path${attr("d", `M${stringify(bW * .7)},-60 L${stringify(bW * .7)},${stringify(bH + 60)}`)} stroke-dasharray="2 28" pathLength="500"><animate attributeName="stroke-dashoffset" from="0" to="-30" dur="2.8s" repeatCount="indefinite"></animate></path></g><g fill="var(--bg-2)" stroke="var(--accent)" stroke-width="4" opacity="0.4"><circle cx="293" cy="-60" r="6"></circle><circle cx="907" cy="-60" r="6"></circle><circle cx="-60" cy="450" r="6"></circle><circle cx="293" cy="720" r="6"></circle><circle cx="600" cy="720" r="6"></circle><circle${attr("cx", bW - 30)}${attr("cy", bH + 60)} r="6"></circle><circle${attr("cx", bW * .7)}${attr("cy", bH + 60)} r="6"></circle></g></svg> <svg class="pipe-bg-mobile svelte-6t9lhf"${attr("viewBox", vb)} preserveAspectRatio="none" aria-hidden="true"><g fill="none" stroke="var(--accent)" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" opacity="0.25"><path${attr("d", `M${stringify(bW * .25)},-60 L${stringify(bW * .25)},${stringify(bH * .33 - 40)} A40,40,0,0,0,${stringify(bW * .25 + 40)},${stringify(bH * .33)} L${stringify(bW * .75 - 40)},${stringify(bH * .33)} A40,40,0,0,1,${stringify(bW * .75)},${stringify(bH * .33 + 40)} L${stringify(bW * .75)},${stringify(bH * .67 - 40)} A40,40,0,0,1,${stringify(bW * .75 - 40)},${stringify(bH * .67)} L${stringify(bW * .25 + 40)},${stringify(bH * .67)} A40,40,0,0,0,${stringify(bW * .25)},${stringify(bH * .67 + 40)} L${stringify(bW * .25)},${stringify(bH + 60)}`)}></path></g><g fill="none" stroke="var(--accent)" stroke-linecap="round" stroke-width="2" opacity="0.40"><path${attr("d", `M${stringify(bW * .25)},-60 L${stringify(bW * .25)},${stringify(bH * .33 - 40)} A40,40,0,0,0,${stringify(bW * .25 + 40)},${stringify(bH * .33)} L${stringify(bW * .75 - 40)},${stringify(bH * .33)} A40,40,0,0,1,${stringify(bW * .75)},${stringify(bH * .33 + 40)} L${stringify(bW * .75)},${stringify(bH * .67 - 40)} A40,40,0,0,1,${stringify(bW * .75 - 40)},${stringify(bH * .67)} L${stringify(bW * .25 + 40)},${stringify(bH * .67)} A40,40,0,0,0,${stringify(bW * .25)},${stringify(bH * .67 + 40)} L${stringify(bW * .25)},${stringify(bH + 60)}`)} stroke-dasharray="2 28" pathLength="1000"><animate attributeName="stroke-dashoffset" from="0" to="-30" dur="2.8s" repeatCount="indefinite"></animate></path></g><g fill="var(--bg-2)" stroke="var(--accent)" stroke-width="2.5" opacity="0.45"><circle${attr("cx", bW * .25)}${attr("cy", -60)} r="9"></circle><circle${attr("cx", bW * .25)}${attr("cy", bH + 60)} r="9"></circle></g></svg> <!--[-->`);
...
function WhyUs($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<!--]--></div></div> <div class="stat-strip svelte-1jcw1x9" aria-label="Key stats"><div class="stat-track svelte-1jcw1x9"><!--[-->`);
		const each_array_1 = ensure_array_like(Array(4));
		for (let $$index_1 = 0, $$length = each_array_1.length; $$index_1 < $$length; $$index_1++) {
			each_array_1[$$index_1];
			$$renderer.push(`<div class="stat-item svelte-1jcw1x9"><span class="stat-val svelte-1jcw1x9">10<span class="stat-unit svelte-1jcw1x9">+</span></span> <span class="stat-label svelte-1jcw1x9">Years on Umbraco</span></div> <span class="stat-sep svelte-1jcw1x9" aria-hidden="true">—</span> <div class="stat-item svelte-1jcw1x9"><span class="stat-val svelte-1jcw1x9">80<span class="stat-unit svelte-1jcw1x9">+</span></span> <span class="stat-label svelte-1jcw1x9">Sites launched</span></div> <span class="stat-sep svelte-1jcw1x9" aria-hidden="true">—</span> <div class="stat-item svelte-1jcw1x9"><span class="stat-val svelte-1jcw1x9">100<span class="stat-unit svelte-1jcw1x9">%</span></span> <span class="stat-label svelte-1jcw1x9">Delivery rate</span></div> <span class="stat-sep svelte-1jcw1x9" aria-hidden="true">—</span>`);
		}
		$$renderer.push(`<!--]--></div></div></section>`);
	});
}
